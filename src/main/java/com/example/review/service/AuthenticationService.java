...
public class AuthenticationService {
    ...
    public IntrospectResponse introspect(IntrospectRequest request) throws ParseException, JOSEException {
        ...
        return IntrospectResponse.builder().authenticate(authenticated).build();
    }

    private SignedJWT verifyToken(String token, final boolean isRefresh) throws JOSEException, ParseException {
    ...
    public void logout(LogoutRequest request) throws ParseException, JOSEException {
        ...
        invalidatedTokenRepository.save(
                InvalidatedToken.builder().id(jit).expiryDate(date).build());
    }
    ...
    public AuthenticationResponse refreshToken(RefreshRequest request) throws ParseException, JOSEException {
        ...
        invalidatedTokenRepository.save(
                InvalidatedToken.builder().id(jid).expiryDate(expiryTime).build());
